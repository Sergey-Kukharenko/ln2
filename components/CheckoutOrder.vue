<template>
  <div class="order">
    ...
    <div class="order__row" style="margin-top: 8px">
      ...
      <div class="order__text-price">{{ checkoutCost.deliveryAmount }}</div>
    </div>
    <div class="order__row order__total">
      <div class="order__text-medium">Total</div>
      <div class="order__text-summary">£ {{ checkoutCost.totalSum }}</div>
    </div>
    <div v-if="checkoutCost.cashback" class="order__row">
      <div class="order__text-grey">Cashback</div>
      <div class="order__text-cashback">
        <svg-icon class="order__icon-coins" name="coins" />
        <div>£ {{ checkoutCost.cashback }}</div>
      </div>
    </div>
  </div>
</template>
